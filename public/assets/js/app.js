  ...
  static addToDom() {
    ...
    Cart.cartItems.forEach((i) => {
      ...
      <div class="flex flex-col gap-1">
        <button class="plus bg-primary w-[18px] h-[18px] sm:w-6 sm:h-6 flex items-center justify-center pt-1 text-primary-content text-lg sm:text-xl rounded-full">+</button>
        <p class="text-sm text-neutral-content flex justify-center items-center mt-1.5">${i.quantity}</p>
        <button class="minus border border-primary h-[18px] w-[18px] sm:w-6 sm:h-6 flex items-center justify-center text-primary text-lg sm:text-[30px] rounded-full"><p class="mt-[3px]">-</p></button>
      </div>
      <button>
